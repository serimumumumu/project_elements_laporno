    ...
    <div class="overlay-overmain">
      <div class="modal_section2">
        ...
        <div class="gacha_button">
            <button class="gacha_one" onclick="location.href='../html/gacharesult.html'"><span class="gacha_one_span">１回</span>(000pt)</button>
            <button class="gacha_one withheart" onclick="location.href='../html/gacharesult.html'"><span class="gacha_one_span">１０回</span>(000pt)
                <img class="gacha_heart" src="../../img/gacha_heart.png" alt="">
            </button>
        </div>
        <div class="lp_button">
          <p>所持LP:<span class="havelp">33,000pt</span></p>
          <button  id="btn-3" onclick="location.href='../html/buylp.html'">LP購入</button>
        </div>
      </div>
    </div>
  </div>
...
Vue.component('rakusaru',{
  ...
  <div class="float_area_a">
        <a class="" @click="openModal">入札する</a>
