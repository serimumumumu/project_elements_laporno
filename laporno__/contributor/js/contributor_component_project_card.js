Vue.component('contributorprojectcard',{
    name: "contributorprojectcard" ,
    template:`
...
//プロジェクトカード終了
Vue.component('contributorprojectendcard',{
    name: "contributorprojectendcard" ,
    template:`
    <div class="compo_card relative" >
        <img src="../../img/demoimg.png" alt="" class="compo_main_img">
        <div class="proj_card_inner">
         <a href="../../contributor/html/contributor_project_end_detail.html" >
                <div class="proj_card_title">【新村あかり】念願の脚本家として作品を作りたい</div>
                <div class="proj_card_info">
                    <div class="">
                        <div class="info-inner">
