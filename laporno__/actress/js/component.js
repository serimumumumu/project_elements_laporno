...
<header>
    <div class="header-left">
         <a href="../../user/html/user_top.html" id="top"><img src="../../img/logo.png" alt="ラポルノロゴ"></a>
    </div>
    <div class="header-right">
        ...
        <div class="menu" v-show="open">
            ...
            <ul>
                <li><a href="../../user/html/user_mypage.html">マイページ</a></li>
                <li><a href="../../user/html/user_campaign.html">キャンペーンページ</a></li>
                <li><a href="../html/user_news_top.html">お知らせ</a></li>
                <li><a href="../html/projtop.html">プロジェクトTOP</a></li>
                <li><a href="../html/auctiontop.html">オークションTOP</a></li>
                <li><a href="../html/gachatop.html">ガチャTOP</a></li>
                <li><a href="../html/buylp.html">LP購入</a></li>
                <li><a >お気に入り</a></li>
                <li><a href="../html/user_mypage.html">設定</a></li>
                <li><a href="../html/inquiry.html">お問い合わせ</a></li>
                <li><a href="">ログアウト</a></li>
            </ul>
            <div class="sns">
                <a href="../../user/html/user_top.html"><img src="../../img/twitter.png" alt=""></a>
...
Vue.component('maker',{
    ...
    <div class="compo_card">
        ...
        <div class="auc_card_inner">
            <a href="../html/contributordetail.html" class="joyu_card_info">
...
Vue.component('actress',{
    ...
    <div class="compo_card">
        ...
        <div class="auc_card_inner">
            <a href="../../user/actressdetail.html" class="joyu_card_info">
                <div class="info-inner">
...
Vue.component('gachacard',{
    ...
    template:`
    <div class="compo_card">
        <a href="../html/gachadetail.html" class="gatya_card_imgarea">
            <img src="../../img/demoimg.png" alt="" class="compo_main_img">
        </a>
        <div class="gatya_card_inner">
            <a href="../html/gachadetail.html" class="gatya_card_title">ガチャのタイトルがガチャのタイトルがここに入りますよ</a>
            <a href="../html/gachadetail.html">
                <div class="info-inner">
...
Vue.component('gachaendcard',{
    ...
    template:`
    <div class="compo_card">
        <a href="../html/gachaenddetail.html" class="gatya_card_imgarea">
            <img src="../../img/demoimg.png" alt="" class="compo_main_img">
        </a>
        <div class="gatya_card_inner">
            <a href="../html/gachaenddetail.html" class="gatya_card_title">ガチャのタイトルがガチャのタイトルがここに入りますよ</a>
            <a href="../html/gachaenddetail.html">
                <div class="info-inner">
                    <img src="../../img/time.png" alt="">
                    <div>終了しました</div>
                </div>
...
Vue.component('auchcard',{
    ...
    <div class="compo_card relative" >
        ...
        <a href="../html/auchdetail.html" class="auc_card_inner">
...
Vue.component('auchendcard',{
    ...
    <div class="compo_card relative" >
        <img src="../../img/demoimg.png" alt="" class="compo_main_img">
        <a href="../html/auchenddetail.html" class="auc_card_inner">
            <div class="auc_card_title">【新村あかり】着用済みワンピース</div>
            <div class="auc_card_detail">
                <div class="info-inner">
                    <img src="../../img/lady.png" alt="">
...
Vue.component('projsellcard',{
    ...
    <div class="compo_card relative" >
        <img src="../../img/demoimg.png" alt="" class="compo_main_img">
        <div class="auc_card_inner">
         <a href="../html/projenddetail.html" >
                <div class="gatya_card_title">【新村あかり】念願の脚本家として作品を作りたい</div>
                <div class="proj_card_info">
                    <div class="">
                        <div class="info-inner">
